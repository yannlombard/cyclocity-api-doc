...
| `GET`             | `/contracts/lyon/defects?valid=`                                                                                                                           | C     | Défauts, répond `415`/`406` sans le bon media-type (inconnu) ; route de 2018, l'app courante lit `/defect-types` ci-dessus                                                                                                                                                                                                                                                                                                                   | 📚                |
