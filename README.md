...
- **Statut de vérification par endpoint** (✅ observé / 🌐 déclaré / 📚 🧩 rapporté) pour savoir à quoi se fier (légende en tête du § 5).
...
Chaque endpoint du § 5 porte un **statut de vérification** (✅ observé en capture, ✅ live vérifié par requête directe, 🌐 déclaré dans le front web, 📚 / 🧩 rapporté par Pikari0 / VLSKit) ; légende complète en tête du § 5.
...
| Trajets                  | `application/vnd.trip.v5+json`                                                          | `trips`, `trips/ongoing`, `POST .../trips`                                                         |
...
| `GET`             | `/contracts/lyon/defect-types?domain=&category=&active=`                                                                                                   | C     | Types de défauts signalables (`vnd.defect-type.v1`)                                                                                                                                                                                                                                                                                                                                                                                          | 🧩                |
...
| `GET`             | `/contracts/lyon/defects?valid=`                                                                                                                           | C     | Défauts, répond `415`/`406` sans le bon media-type (inconnu)                                                                                                                                                                                                                                                                                                                                                                                 | 📚                |
...
| `POST`         | `/contracts/lyon/accounts/{id}/trips/{tripId}/rate`                            | C+I          | Noter le vélo d'un trajet                                                                                                                                                                                                                                                     | 📚           |
...
| `POST` | `/accounts/{id}/trips/{tripId}/rate`          | C+I  | Noter le vélo                            | 📚     |
...
| `RATE_BIKE`           | RULE      | 5        | Noter le vélo                 |
